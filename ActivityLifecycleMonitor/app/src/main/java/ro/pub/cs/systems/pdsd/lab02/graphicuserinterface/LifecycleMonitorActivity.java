...
public class LifecycleMonitorActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
		...
		if (savedInstanceState != null) {
			Log.d(Constants.TAG, "restoring");
			EditText usernameEditText = (EditText) findViewById(R.id.username_edit_text);
			EditText passwordEditText = (EditText) findViewById(R.id.password_edit_text);
			CheckBox check = (CheckBox) findViewById(R.id.remember_me_checkbox);

			String user = savedInstanceState.getString(Constants.USERNAME_EDIT_TEXT);
			String pass = savedInstanceState.getString(Constants.PASSWORD_EDIT_TEXT);
			Boolean checkbool = savedInstanceState.getBoolean(Constants.REMEMBER_ME_CHECKBOX);

			usernameEditText.setText(user);
			passwordEditText.setText(pass);
			check.setChecked(checkbool);
		}
		...
		String msg;
		if (savedInstanceState == null)
			msg = "no saved instance state";
		else {
			msg = "app has saved instance state";
		}
	...
	public void onSaveInstanceState(Bundle outstate) {
		...
		if (check.isChecked()) {
			...
			outstate.putBoolean(Constants.REMEMBER_ME_CHECKBOX, check.isChecked());
		}
